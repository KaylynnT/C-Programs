...
int main() {
	...
	//read in the next integer from the keyboard into an integer named numberOfStudents
	scanf("%d", &numberOfStudents);
	//start a for loop that initializes i to 1, runs while i is smaller than or equal to numberOfStudents, and increments i
