...
COSC1336 002
11/22/2023
Purpose: To collect and display basic baseball stats using parallel arrays (Lab7L3)*/
...
void main() {
	...
	for (int i = 0; i< numberOfPlayers; i++) {
		printf("Please enter the number of hits for players %d:", i + 1);
		scanf("%d", &hits[i]);
	...
	printf("\nPlayer Number\tHits\tAt Bats\tBattering Average\n");
	for (int i = 0; i < numberOfPlayers; i++)
